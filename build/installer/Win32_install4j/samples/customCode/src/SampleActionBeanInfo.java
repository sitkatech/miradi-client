    ...
    private static class DetailEnumerationMapper implements EnumerationMapper {
        ...
        public EnumerationMapEntry[] getEnumerationMapEntries() {
            return new EnumerationMapEntry[] {
                ...
                new EnumerationMapEntry("None", new Integer(SampleAction.DETAIL_NONE)),
                new EnumerationMapEntry("Show percent", new Integer(SampleAction.DETAIL_PERCENT)),
                new EnumerationMapEntry("Show counter", new Integer(SampleAction.DETAIL_COUNTER))
            };
        }
