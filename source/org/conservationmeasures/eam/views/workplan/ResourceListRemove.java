...
public class ResourceListRemove extends ObjectsDoer
{
	...
	public void doIt() throws CommandFailedException
	{
		...
		try
		{
			...
			Command cmd = CommandSetObjectData.createRemoveIdCommand(selectedActivity, selectedActivity.TAG_RESOURCE_IDS, selectedResourceId);
