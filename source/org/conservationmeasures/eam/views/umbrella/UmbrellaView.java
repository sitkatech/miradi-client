...
import org.conservationmeasures.eam.actions.ActionExportPDFProjectReportFile;
...
abstract public class UmbrellaView extends JPanel implements CommandExecutedListener
{
	...
	private void addUmbrellaDoersToMap()
	{
		...
		addDoerToMap(ActionExportRTFProjectReportFile.class, new ExportRTFProjectReportFileDoer());
		addDoerToMap(ActionExportPDFProjectReportFile.class, new ExportPDFProjectReportFileDoer());
