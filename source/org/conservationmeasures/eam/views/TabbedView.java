...
abstract public class TabbedView extends UmbrellaView
{
	...
	public void becomeActive() throws Exception
	{
		super.becomeActive();
		removeAll();
		bigSplitter = new ViewSplitPane(getMainWindow(), getProject().getCurrentView(),createWizardPanel(), tabs);
	...
	public void addNoneScrollableTab(ObjectPoolManagementPanel panel)
	{
