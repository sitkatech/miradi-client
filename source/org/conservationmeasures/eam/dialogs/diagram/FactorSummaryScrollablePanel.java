...
{
	public FactorSummaryScrollablePanel(Project projectToUse, DiagramFactor diagramFactorToUse) throws Exception
	{
		summaryPanel = new FactorSummaryPanel(projectToUse, diagramFactorToUse);
