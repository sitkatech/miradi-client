...
public class EAMPDFFileChooser extends EAMFileSaveChooser
{

	public EAMPDFFileChooser(MainWindow mainWindow)
	{
		super(mainWindow);
	}
	...
	{
		return "Title|Save PDF File";
	}

	public String getApproveButtonToolTipText()
	{
		return "TT|Save PDF File";
	}
