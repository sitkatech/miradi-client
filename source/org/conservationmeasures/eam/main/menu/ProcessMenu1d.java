...
public class ProcessMenu1d extends MiradiMenu
{
	...
	public ProcessMenu1d(Actions actionsToUse)
	{
		...
		addMenuItem(ActionJumpAssessStakeholders.class, KeyEvent.VK_A);
		addMenuItem(ActionJumpAnalyzeProjectCapacity.class, KeyEvent.VK_A);
		
		addMenuItem(ActionJumpArticulateCoreAssumptions.class, KeyEvent.VK_A);
		addMenuItem(ActionJumpDiagramWizardReviewModelAndAdjustStep.class, KeyEvent.VK_C);
