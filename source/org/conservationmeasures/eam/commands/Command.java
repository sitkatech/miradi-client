...
public abstract class Command
{
	...
	public static Command createFrom(String commandName, DataInputStream dataIn) throws IOException, UnknownCommandException
	{
		...
		if(commandName.equals(CommandSetFactorType.COMMAND_NAME))
			return new CommandSetFactorType(dataIn);
		...
		if(commandName.equals(CommandSetNodeComment.COMMAND_NAME))
			return new CommandSetNodeComment(dataIn);
