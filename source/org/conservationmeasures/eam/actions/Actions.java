...
public class Actions
{
	public Actions(MainWindow mainWindow)
	{
		...
		registerAction(new ActionJumpDiagramWizardDescribeTargetStatusStep(mainWindow));
		registerAction(new ActionJumpIdentifyDiagramWizardIdentifyDirectThreatStep(mainWindow));
		...
		registerAction(new ActionJumpMonitoringOverviewStep(mainWindow));
