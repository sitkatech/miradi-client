...
abstract public class AbstractDiagramTarget extends FactorCell
{
	protected AbstractDiagramTarget(Factor factorToWrap, DiagramFactor diagramFactorToUse)
	{
	...
	abstract protected String getColorTag();
}
