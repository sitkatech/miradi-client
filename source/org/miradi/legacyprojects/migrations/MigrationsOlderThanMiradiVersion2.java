...
import org.miradi.legacyprojects.DataUpgraderDiagramObjectLinkAdder;
...
//				));
	...
	public static void moveFactorLinkCommentFieldsIntoThreatRatingCommentsData() throws Exception
	{
		...
		for (int i = 0; i < factorLinkIds.length; ++i)
		{
			...
			{	
				...
				simpleThreatRatingCommentsMap.rawPutForLegacyMigrations(threatRatingCommentsKey, simpleThreatRatingComment);
				...
				stressThreatRatingCommentsMap.rawPutForLegacyMigrations(threatRatingCommentsKey, stressThreatRatingComment);
	...
	public static boolean asBoolean(String booleanAsString)
	{
		...
		final String LEGACY_FALSE_VALUE = "0";
		if (booleanAsString.equals(LEGACY_FALSE_VALUE))
			return false;
