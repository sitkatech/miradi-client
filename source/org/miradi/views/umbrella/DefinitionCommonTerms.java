...
public class DefinitionCommonTerms
{
    static
    {
		...
		Definition def = Definition.createDefinitionFromTextString("Goal", "Goal - A formal statement detailing a desired impact of a project. " +
		...
		def = Definition.createDefinitionFromTextString("Chain", "Chain - A sequence of linked factors in a diagram. " +
		...
		def = Definition.createDefinitionFromTextString("Conservation Targets", "Targets - A limited suite of species, communities, and ecological systems " +
		...
		def = Definition.createDefinitionFromTextString("Stress", "Stress - An impaired aspect of a conservation target " +
		...
		def = Definition.createDefinitionFromTextString("Ecosystems", "Ecosystems - The ecological systems that characterize the " +
		"terrestrial, aquatic, and marine biodiversity of the project site. ");
		defs.put("Definition:Ecosystems", def);
		
		
		def = Definition.createDefinitionFromTextString("Focal Species", "Focal Species - These include species endemic to the ecoregion, " +
		...
		def = Definition.createDefinitionFromTextString("Ecological Processes", "Ecological Processes - Ecological processes that create and maintain " +
		...
		def = Definition.createDefinitionFromTextString("Direct Threat", "Direct threat - A proximate agent or factor that directly " +
		...
		def = Definition.createDefinitionFromTextString("Classifications of Direct Threats", "Direct threats can be classified according to the new " +
		...
		def = Definition.createDefinitionFromTextString("Contributing Factor", "Contributing factor (Indirect threats and Opportunities) " +
		...
		def = Definition.createDefinitionFromTextString("Conceptual Model", "Conceptual model - A diagram of a set of relationships " +
		...
		def = Definition.createDefinitionFromTextString("Scope", "Scope - The broad geographic or thematic focus of a project. In Miradi, a project's scope is represented by a green box around the targets.");
		defs.put("Definition:Scope", def);
		
		
		def = Definition.createDefinitionFromTextString("Scope (Threat Ratings)", "Scope (Threat Ratings) - A threat rating criterion that is most commonly defined " +
		...
		def = Definition.createDefinitionFromTextString("Vision", "Vision - A general summary of the desired state or " +
		"ultimate condition of the project area that a project is working to achieve.");
		defs.put("Definition:Vision", def);
		

		def = Definition.createDefinitionFromTextString("Indicator", "Indicator - A measurable entity related to a specific information need " +
		...
		def = Definition.createDefinitionFromTextString("KEA", "KEA (Key Ecological Attribute) - An aspect of a target's biology or ecology " +
		...
		def = Definition.createDefinitionFromTextString("Method", "Method - A specific technique used to collect data to measure an indicator.  " +
		...
		def = Definition.createDefinitionFromTextString("Monitoring Plan", "Monitoring Plan - A plan for collecting information that you and others " +
		...
		def = Definition.createDefinitionFromTextString("Strategy Effectiveness", "Strategy Effectiveness - Information used to answer the question: Are the conservation actions " +
		"we are taking achieving their desired results?");
		defs.put("Definition:StrategyEffectiveness", def);
		

		def = Definition.createDefinitionFromTextString("Status Assessments", "Status Assessments - Information used to answer the questions how are key targets, threats, " +
		...
		def = Definition.createDefinitionFromTextString("Objective", "Objective - A formal statement detailing a desired " +
		...
		def = Definition.createDefinitionFromTextString("StrategicPlan", "Strategic plan - An outline of how the project team proposes to" +
		" change the world that contains a project's goals, objectives," +
		" and strategies.");
		defs.put("Definition:StrategicPlan", def);

		
		def = Definition.createDefinitionFromTextString("Strategy", "Strategy - A broad course of action designed to restore natural systems, " +
		...
		def = Definition.createDefinitionFromTextString("Initial Project Team", "Initial Project Team - The people who conceive of and initiate the project.");
		defs.put("Definition:InitialProjectTeam", def);
		
		
		def = Definition.createDefinitionFromTextString("Work Plan", "Work Plan - A description of the specific activities/methods and tasks that " +
		...
		def = Definition.createDefinitionFromTextString("Activity", "Activity - An action carried out to accomplish one or more of a project's strategies. In Miradi, an activity is represented by a yellow flattened oval.");
		defs.put("Definition:Activity", def);
		
		
		def = Definition.createDefinitionFromTextString("Task", "Task - A specific action required in service of an activity or method.  Tasks themselves can " +
		...
		def = Definition.createDefinitionFromTextString("Quarter", "Quarter - A planning period encompassing 3 months. If you are using a Western calendar, " +
		...
		def = Definition.createDefinitionFromTextString("Resource", "Resource - A person or item that is needed to complete an activity/method or a task. " +
		"There are three main kinds of resources - human, material, and financial.");
		defs.put("Definition:Resource", def);
		
		
		def = Definition.createDefinitionFromTextString("Overall Threat Rating", "Target-Threat Rating - The rating of the effect of a direct threat on a specific target. " +
		...
		def = Definition.createDefinitionFromTextString("Irreversibility", "<html>Irreversibility - The degree to which the effects of a " +
				"threat can be revcersed and the target affected by the threat restored. ");
		defs.put("Definition:Irreversibility", def);

		def = Definition.createDefinitionFromTextString("Severity", "Severity - Within the scope, the level of damage to the target from the threat " +
		...
		def = Definition.createDefinitionFromTextString("Contribution", "Contribution - A threat rating criterion defined as the expected contribution of the source, " +
		...
		def = Definition.createDefinitionFromTextString("Project", "<html>Project (general) - Any set of actions undertaken by a group of people and/or " +
		...
		def = Definition.createDefinitionFromTextString("CMP", "The Conservation Measures Partnership (CMP) - A consortium of some of " +
		...
		def = Definition.createDefinitionFromTextString("OpenStandards", "Open Standards for the Practice of Conservation - A series of best practices " +
		...
		def = Definition.createDefinitionFromTextString("ImportZip", "Zipped Project - A project folder that has been compressed using the zip format. " +
		...
		def = Definition.createDefinitionFromTextString("Budget", "Budget - A forward looking projection of the " +
		...
		def = Definition.createDefinitionFromTextString("ActualExpenditures", "Actual Expenditures - A backwards looking " +
		...
		def = Definition.createDefinitionFromTextString("AccountingCodes", "Accounting Codes - A set of categories " +
		...
		def = Definition.createDefinitionFromTextString("TabDelimitedFile", "Tab Delimited File - A software file " +
		...
		def = Definition.createDefinitionFromTextString("Funding Sources", "Funding Sources - The sources of money available to your project.");
		defs.put("Definition:FundingSources", def);


		def = Definition.createDefinitionFromTextString("ThreatReductionResult", "Threat Reduction Result - A factor in a results chain that describes the desired change in a direct threat that results from implementing one or more conservation strategies. In Miradi, at threat reduction result is represented by a purple rectangle.");
		defs.put("Definition:ThreatReductionResult", def);

		def = Definition.createDefinitionFromTextString("IntermediateResult", "Intermediate Result - A factor in a results chain that describes a specific outcome that results from implementing one or more conservation strategies. In Miradi, an intermediate result is represented by a blue rectangle.");
		...
		def = Definition.createDefinitionFromTextString("AcceptableRangeofVariation", "Acceptable Range of Variation - Key ecological attributes of focal targets naturally vary over time. The acceptable range defines the limits of this variation which constitute the minimum conditions for persistence of the target (note that persistence may still require human management interventions).  This concept of an acceptable range of variation establishes the minimum criteria for identifying a conservation target as \"conserved\" or not.  If the attribute lies outside this acceptable range, it is a \"degraded\" attribute.");
		defs.put("Definition:ViabilityRatings", def);

		def = Definition.createDefinitionFromTextString("Measurement", "Measurement - A n assessment of an indicator at a given point in time. Measurements can be either quantitative or qualitative.");
		defs.put("Definition:Measurement", def);	

		def = Definition.createDefinitionFromTextString("PriorityRating", "Priority Rating - An assesment of the importance or urgency or collecting measurements for a given indicator.");
		defs.put("Definition:PriorityRating", def);	

		def = Definition.createDefinitionFromTextString("DesiredFutureStatus", "Desired Future Status - A measurement or rating value for an indicator for a key ecological attribute that the project intends to achieve at a specified time in the future. Generally equivalent to a project sub-goal..");
		defs.put("Definition:PriorityRating", def);	
    ...
    static public Definition getDefintion(String key)
    {
    	...
    	if (def==null)
    		return Definition.createDefinitionFromTextString(key, "Undefined");
    	return def;
    }
