...
public class DefinitionCommonTerms
{
    static
    {
		...
		def = Definition.createDefinitionFromTextString(EAM.text("Human Wellbeing Targets"), 
		...
		defs.put("Definition:HumanWellbeingTargets", def);
		...
		defs.put("Definition:AcceptableRangeofVariation", def);
		...
		def = Definition.createDefinitionFromHtmlFilename(EAM.text("Threat Calculations"), "ThreatRatingExplanationOfStressBasedCalculation.html");
		defs.put("Definition:ShowStressBasedRulesCalculations", def);
