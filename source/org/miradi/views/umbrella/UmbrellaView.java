...
import org.miradi.actions.ActionExportCpmzFile;
...
abstract public class UmbrellaView extends JPanel implements CommandExecutedListener
{
	...
	private void addUmbrellaDoersToMap()
	{
		...
		addDoerToMap(ActionImportCpmzFile.class, new ImportCpmzDoer());
		...
		addDoerToMap(ActionExportCpmzFile.class, new ExportCpmzDoer());
