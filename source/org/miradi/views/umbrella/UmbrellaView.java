...
import org.miradi.views.diagram.doers.CreateTaskProgressReportDoer;
import org.miradi.views.diagram.doers.CreateIndicatorProgressReportDoer;
...
import org.miradi.views.diagram.doers.DeleteTaskProgressReportDoer;
...
import org.miradi.views.diagram.doers.EditTaskProgressReportDoer;
...
abstract public class UmbrellaView extends JPanel implements CommandExecutedListener
{
	...
	private void addUmbrellaDoersToMap()
	{
		...
		addDoerToMap(ActionCreateIndicatorProgressReport.class, new CreateIndicatorProgressReportDoer());
		...
		addDoerToMap(ActionEditTaskProgressReports.class, new EditTaskProgressReportDoer());
		addDoerToMap(ActionCreateTaskProgressReport.class, new CreateTaskProgressReportDoer());
		addDoerToMap(ActionDeleteTaskProgressReport.class, new DeleteTaskProgressReportDoer());
