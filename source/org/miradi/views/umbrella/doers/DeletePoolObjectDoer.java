...
abstract public class DeletePoolObjectDoer extends ObjectsDoer
{
	...
	protected void doIt() throws Exception
	{
		...
		try
		{
			...
			try
			{
				...
				getProject().executeCommands(commandsToDeleteChildrenAndObject);
			}
			finally
			{
	...
	{
		removeAssignmentReferenceToObject(objectToDelete, ExpenseAssignmentSchema.getObjectType(), referringTag);
	}
