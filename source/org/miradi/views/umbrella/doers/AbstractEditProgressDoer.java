...
abstract public class AbstractEditProgressDoer extends AbstractPopUpEditDoer
{
	public AbstractEditProgressDoer(int objectTypeToUse)
	{
		super(objectTypeToUse, EAM.text("Edit Progress Percents"));
	}	
