...
public class StrategicPlanAccountingCodeManagementPanel extends AbstractAccountingCodeManagementPanel
{
	public StrategicPlanAccountingCodeManagementPanel(MainWindow mainWindowToUse,
	...
	{
		PlanningTreeTableModel model = AccountingCodeTreeTableModel.createAccountingCodeTreeTableModel(getProject(), rowColumnProvider.getColumnListToShow());
		return ExportablePlanningTreeTablePanel.createPlanningTreeTablePanelWithoutButtons(getMainWindow(), rowColumnProvider, model);
	}

	public static PlanningTreeManagementPanel createAccountingCodePanel(MainWindow mainWindowToUse) throws Exception
	{
		RowColumnProvider rowColumnProvider = new AccountingCodeCoreRowColumnProvider();
		PlanningTreeTableModel treeTableModel = AccountingCodeTreeTableModel.createAccountingCodeTreeTableModel(mainWindowToUse.getProject(), rowColumnProvider.getColumnListToShow());
		...
		return new StrategicPlanAccountingCodeManagementPanel(mainWindowToUse, treeTablePanel, propertiesPanel);
	}
}
