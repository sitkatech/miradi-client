...
public class StrategicPlanFundingSourceManagementPanel extends AbstractFundingSourceManagementPanel
{
	public StrategicPlanFundingSourceManagementPanel(MainWindow mainWindowToUse,
	...
	{
		PlanningTreeTableModel model = FundingSourceTreeTableModel.createFundingSourceTreeTableModel(getProject(), rowColumnProvider.getColumnListToShow());
	...
	{
		RowColumnProvider rowColumnProvider = new FundingSourceCoreRowColumnProvider();
		PlanningTreeTableModel treeTableModel = FundingSourceTreeTableModel.createFundingSourceTreeTableModel(mainWindowToUse.getProject(), rowColumnProvider.getColumnListToShow());
		...
		return new StrategicPlanFundingSourceManagementPanel(mainWindowToUse, treeTablePanel, propertiesPanel);
	}
}
