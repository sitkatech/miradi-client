...
public class SharedWorkPlanCustomizeTableEditorDoer extends AbstractWorkPlanStringMapEditorDoer
{
	...
	{
		return new WorkPlanColumnConfigurationEditorPanel(getProject(), workPlanTableSettings.getRef(), StaticQuestionManager.getQuestion(SharedWorkPlanVisibleRowsQuestion.class));
	}
