...
public class BudgetCategoryOneManagementConfiguration extends WorkPlanManagementPanelConfiguration
{
	...
	{
		return new BudgetCategoryOneCoreRowColumnProvider(getProject());
	}
