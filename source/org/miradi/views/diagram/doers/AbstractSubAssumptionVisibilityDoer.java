...
abstract public class AbstractSubAssumptionVisibilityDoer extends AbstractVisibilityDoer
{
    @Override
    public boolean isAvailable()
    {
        ...
        ORef selectedSubAssumptionRef = getSelectedSubAssumptionRef();
        if (selectedSubAssumptionRef.isInvalid())
            return false;

        return isAvailable(selectedSubAssumptionRef);
    }

    protected ORef getSelectedSubAssumptionRef()
    {
