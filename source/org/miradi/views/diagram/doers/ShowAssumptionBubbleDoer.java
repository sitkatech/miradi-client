...
public class ShowAssumptionBubbleDoer extends AbstractAssumptionVisibilityDoer
{
    @Override
    protected void doWork() throws Exception
    {
        showBubble(DiagramFactor.DEFAULT_ASSUMPTION_SIZE);
    }
    ...
    {
        return ((AnalyticalQuestion) getParent()).getAssumptionRefs();
    }
}
