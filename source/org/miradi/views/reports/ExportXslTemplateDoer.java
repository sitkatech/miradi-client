...
import org.miradi.utils.XslFileSaveChooser;
...
public class ExportXslTemplateDoer extends ObjectsDoer
{
	...
	protected void doIt() throws Exception
	{
		...
		final XslFileSaveChooser fileChooser = new XslFileSaveChooser(getMainWindow());
		...
		try
		{
			xsl = HtmlUtilities.convertStoredXslToNative(xsl);
			writer.write(xsl);
		}
		finally
		{
