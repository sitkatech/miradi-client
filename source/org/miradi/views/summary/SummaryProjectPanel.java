...
import org.miradi.questions.MajorCurrentLanguagesQuestion;
...
public class SummaryProjectPanel extends ObjectDataInputPanel
{
	public SummaryProjectPanel(Project projectToUse, ORef refToUse) throws Exception
	{
		...
		addField(createChoiceField(ProjectMetadataSchema.getObjectType(), ProjectMetadata.TAG_PROJECT_LANGUAGE, new MajorCurrentLanguagesQuestion()));
