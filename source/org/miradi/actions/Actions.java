...
public class Actions
{
	public Actions(MainWindow mainWindow)
	{
		...
		registerMenuAction(new ActionJumpSummaryWizardRolesAndResponsibilities(mainWindow));
		registerMenuAction(new ActionJumpSummaryWizardDefineTeamMembers(mainWindow));
		registerMenuAction(new ActionJumpSummaryWizardDefineProjecScope(mainWindow));
		registerAction(new ActionJumpSummaryWizardDefineProjectVision(mainWindow));
		registerMenuAction(new ActionJumpDiagramWizardDefineTargetsStep(mainWindow));
		...
		registerMenuAction(new ActionJumpDiagramWizardHumanWelfareTargetsStep(mainWindow));
		registerMenuAction(new ActionJumpTargetViabilityMethodChoiceStep(mainWindow));
		registerAction(new ActionJumpTargetViability3Step(mainWindow));
		registerAction(new ActionJumpTargetStressesStep(mainWindow));
		registerMenuAction(new ActionJumpDiagramWizardIdentifyDirectThreatStep(mainWindow));
		registerMenuAction(new ActionJumpThreatMatrixOverviewStep(mainWindow));
		registerMenuAction(new ActionJumpDiagramWizardIdentifyIndirectThreatStep(mainWindow));
		registerMenuAction(new ActionJumpAssessStakeholders(mainWindow));
		...
		registerMenuAction(new ActionJumpDiagramWizardReviewModelAndAdjustStep(mainWindow));
		registerAction(new ActionJumpGroundTruthRevise(mainWindow));
		registerAction(new ActionJumpPlanningOverviewStep(mainWindow));
		registerMenuAction(new ActionJumpStrategicPlanDevelopGoalStep(mainWindow));
		registerMenuAction(new ActionJumpSelectChainStep(mainWindow));
		registerMenuAction(new ActionJumpStrategicPlanDevelopObjectivesStep(mainWindow));
		registerMenuAction(new ActionJumpRankDraftStrategiesStep(mainWindow));
		registerMenuAction(new ActionJumpDiagramWizardResultsChainSelectStrategyStep(mainWindow));
		...
		registerMenuAction(new ActionJumpDiagramWizardDefineAudienceStep(mainWindow));
		registerAction(new ActionJumpDefineAudiences(mainWindow));
		registerMenuAction(new ActionJumpMonitoringWizardDefineIndicatorsStep(mainWindow));
...
//		registerAction(new ActionJumpFinancialOverviewStep(mainWindow));
		...
		registerMenuAction(new ActionJumpImplementWorkPlan(mainWindow));
		...
		registerMenuAction(new ActionJumpPlanningWizardFinalizeStrategicPlanStep(mainWindow));
		registerMenuAction(new ActionJumpPlanningWizardFinalizeMonitoringPlanStep(mainWindow));
...
//		registerAction(new ActionJumpMonitoringPlanOverviewStep(mainWindow));
		...
		registerMenuAction(new ActionJumpWorkPlanDevelopMethodsAndTasksStep(mainWindow));
		registerMenuAction(new ActionJumpWorkPlanDevelopActivitiesAndTasksStep(mainWindow));
		registerAction(new ActionJumpWorkPlanAssignResourcesStep(mainWindow));
		registerMenuAction(new ActionJumpDiagramWizardReviewModelAndAdjustStep(mainWindow));
		...
		registerMenuAction(new ActionJumpWorkPlanDevelopActivitiesAndTasksStep(mainWindow));
		registerMenuAction(new ActionJumpWorkPlanDevelopMethodsAndTasksStep(mainWindow));
		registerMenuAction(new ActionJumpDevelopMap(mainWindow));
		registerMenuAction(new ActionJumpDiagramWizardCreateInitialModelStep(mainWindow));
		registerAction(new ActionJumpFinalizeConceptualModel(mainWindow));
		registerMenuAction(new ActionJumpAssessResources(mainWindow));
		registerMenuAction(new ActionJumpAssessRisks(mainWindow));
		registerMenuAction(new ActionJumpPlanProjectLifespan(mainWindow));
		registerMenuAction(new ActionJumpDevelopSchedule(mainWindow));
		registerMenuAction(new ActionJumpBudgetWizardAccountingAndFunding(mainWindow));
		registerMenuAction(new ActionJumpDevelopFundingProposals(mainWindow));
		registerMenuAction(new ActionJumpObtainFinancing(mainWindow));
		registerMenuAction(new ActionJumpImplementStrategicAndMonitoringPlans(mainWindow));
...
//		registerAction(new ActionJumpWorkPlanOverviewStep(mainWindow));
	...
	private void registerMenuAction(AbstractJumpMenuAction menuAction)
	{
