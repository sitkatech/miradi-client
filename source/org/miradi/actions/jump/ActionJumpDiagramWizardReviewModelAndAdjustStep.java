...
public class ActionJumpDiagramWizardReviewModelAndAdjustStep extends AbstractJumpMenuAction
{
	public ActionJumpDiagramWizardReviewModelAndAdjustStep(MainWindow mainWindowToUse)
	{
		super(mainWindowToUse, OpenStandardsConceptualizeQuestion.getGroundTruthAndReviseModelLabel());
	}
