...
public class ActionTreeCreateIndicator extends ObjectsAction
{
	public ActionTreeCreateIndicator(MainWindow mainWindowToUse)
	{
	...
	{
		return EAM.text("TT|Create an Indicator for the selected Item");
	}
}
