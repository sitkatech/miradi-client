...
public class ActionInsertHumanWelfareTarget extends LocationAction
{
	public ActionInsertHumanWelfareTarget(MainWindow mainWindow)
	{
		super(mainWindow, getLabel(), new HumanWelfareTargetIcon());
	}
