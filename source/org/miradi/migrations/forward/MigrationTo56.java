...
public class MigrationTo56 extends NewlyAddedFieldsMigration
{
    public MigrationTo56(RawProject rawProjectToUse)
    {
        super(rawProjectToUse, ObjectType.THREAT_REDUCTION_RESULT);
    }
    ...
    protected HashMap<String, String> createFieldsToLabelMapToModify()
    {
        ...
        fieldsToAdd.put(TAG_RESULT_REPORT_REFS, EAM.text("Threat Reduction Results Result Reports"));
    ...
    {
        return EAM.text("This migration adds Result Reports to Threat Reduction Results.");
    }
    ...
    public static final int VERSION_FROM = 55;
    public static final int VERSION_TO = 56;
