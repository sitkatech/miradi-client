...
public class MigrationTo78 extends AbstractMigration
{
    ...
    {
        return EAM.text("This migration adds Assumptions to Analytical Questions.");
    }
    ...
    private class AssumptionVisitor extends AbstractMigrationORefVisitor
    {
        ...
        private MigrationResult addFields(RawObject rawObject) throws Exception
        {
            ...
            rawObject.setData(TAG_ASSUMPTION_REFS, "");
        ...
        private MigrationResult removeFields(RawObject rawObject) throws Exception
        {
            ...
            if (rawObject.hasValue(TAG_ASSUMPTION_REFS))
                rawObject.remove(TAG_ASSUMPTION_REFS);
    ...
    public static final String TAG_ASSUMPTION_REFS = "AssumptionRefs";
}
