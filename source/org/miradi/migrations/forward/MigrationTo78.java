...
public class MigrationTo78 extends AbstractMigration
{
    public MigrationTo78(RawProject rawProjectToUse)
    {
    ...
    {
        return EAM.text("This migration adds relevant Goals, Objectives and Indicators to Outputs.");
    }
    ...
    private Vector<Integer> getTypesToMigrate()
    {
        ...
        typesToMigrate.add(ObjectType.OUTPUT);
    ...
    private class OutputVisitor extends AbstractMigrationORefVisitor
    {
        ...
        private MigrationResult addFields(RawObject rawObject) throws Exception
        {
            ...
            rawObject.setData(TAG_GOAL_IDS, "");
            rawObject.setData(TAG_OBJECTIVE_IDS, "");
            rawObject.setData(TAG_INDICATOR_IDS, "");
        ...
        private MigrationResult removeFields(RawObject rawObject) throws Exception
        {
            ...
            if (rawObject.hasValue(TAG_GOAL_IDS))
                rawObject.remove(TAG_GOAL_IDS);

            if (rawObject.hasValue(TAG_OBJECTIVE_IDS))
                rawObject.remove(TAG_OBJECTIVE_IDS);

            if (rawObject.hasValue(TAG_INDICATOR_IDS))
                rawObject.remove(TAG_INDICATOR_IDS);
    ...
    public static final int VERSION_FROM = 77;
    public static final int VERSION_TO = 78;
