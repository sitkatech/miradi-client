...
public class MigrationTo32 extends NewlyAddedFieldsMigration
{
	...
	protected HashMap<String, String> createFieldsToLabelMapToModify()
	{
		...
		fieldsToAdd.put(TAG_RELEVANT_STRATEGY_ACTIVITY_SET, EAM.text("Indicator Relevant Strategy / Activity Set"));
	...
	{
		return EAM.text("This migration adds a new field to the Indicator properties.");
	}
