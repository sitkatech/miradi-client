...
public class MigrationTo55 extends NewlyAddedFieldsMigration
{
    public MigrationTo55(RawProject rawProjectToUse)
    {
        super(rawProjectToUse, ObjectType.INTERMEDIATE_RESULT);
    }
    ...
    protected HashMap<String, String> createFieldsToLabelMapToModify()
    {
        ...
        fieldsToAdd.put(TAG_RESULT_REPORT_REFS, EAM.text("Intermediate Results Result Reports"));
    ...
    {
        return EAM.text("This migration adds Result Reports to Intermediate Results.");
    }
    ...
    public static final int VERSION_FROM = 54;
    public static final int VERSION_TO = 55;
