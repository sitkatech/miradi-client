...
public class MigrationTo88 extends NewlyAddedFieldsMigration
{
    public MigrationTo88(RawProject rawProjectToUse)
    {
        super(rawProjectToUse, CauseSchema.getObjectType());
    }
    ...
    {
        return EAM.text("This migration adds a new field to the Threat properties.");
    }

    public static final int VERSION_FROM = 87;
    public static final int VERSION_TO = 88;
