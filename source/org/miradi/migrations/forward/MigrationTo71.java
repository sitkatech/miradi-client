...
public class MigrationTo71 extends NewlyAddedFieldsMigration
{
    public MigrationTo71(RawProject rawProjectToUse)
    {
    ...
    public static final int VERSION_FROM = 70;
    public static final int VERSION_TO = 71;
