...
public class MigrationTo59 extends NewlyAddedFieldsMigration
{
    public MigrationTo59(RawProject rawProjectToUse)
    {
        super(rawProjectToUse, HumanWelfareTargetSchema.getObjectType());
    }
    ...
    {
        return EAM.text("This migration adds new fields to Human Welfare Target properties.");
    }

    public static final int VERSION_FROM = 58;
    public static final int VERSION_TO = 59;
