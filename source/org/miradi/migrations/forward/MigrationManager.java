...
public class MigrationManager extends AbstractMigrationManager
{
	...
	private Vector<AbstractMigration> createMigrations(RawProject rawProject)
	{
		...
		migrations.add(new MigrationTo67(rawProject));
		migrations.add(new MigrationTo68(rawProject));
		migrations.add(new MigrationTo69(rawProject));
		migrations.add(new MigrationTo70(rawProject));
		migrations.add(new MigrationTo71(rawProject));
		migrations.add(new MigrationTo72(rawProject));
		migrations.add(new MigrationTo73(rawProject));
		migrations.add(new MigrationTo74(rawProject));
		...
		migrations.add(new MigrationTo82(rawProject));
		migrations.add(new MigrationTo83(rawProject));
		migrations.add(new MigrationTo84(rawProject));
		migrations.add(new MigrationTo85(rawProject));
		migrations.add(new MigrationTo86(rawProject));
		migrations.add(new MigrationTo87(rawProject));
		migrations.add(new MigrationTo88(rawProject));
		migrations.add(new MigrationTo89(rawProject));
		migrations.add(new MigrationTo90(rawProject));
	...
	public static int getLatestMigrationForDocumentSchemaVersion(int documentSchemaVersion) throws Exception
	{
		...
		// 4.6 RC-> 248
		if (documentSchemaVersionAsString.equals(Xmpz2XmlConstants.NAME_SPACE_VERSION_248))
			return MigrationTo90.VERSION_TO;

		// 4.6j -> 247
		if (documentSchemaVersionAsString.equals(Xmpz2XmlConstants.NAME_SPACE_VERSION_247))
			return MigrationTo88.VERSION_TO;

		// 4.6i -> 246
		if (documentSchemaVersionAsString.equals(Xmpz2XmlConstants.NAME_SPACE_VERSION_246))
			return MigrationTo86.VERSION_TO;

		// 4.6h -> 245
		if (documentSchemaVersionAsString.equals(Xmpz2XmlConstants.NAME_SPACE_VERSION_245))
			return MigrationTo85.VERSION_TO;

		// 4.6g -> 244
		if (documentSchemaVersionAsString.equals(Xmpz2XmlConstants.NAME_SPACE_VERSION_244))
