...
public class MigrationTo82 extends AbstractMigration
{
    public MigrationTo82(RawProject rawProjectToUse)
    {
    ...
    private MigrationResult migrate(boolean reverseMigration) throws Exception
    {
        ...
        {
            final RenameTaxonomyCodeFieldVisitor visitor = new RenameTaxonomyCodeFieldVisitor(typeToVisit, reverseMigration);
    ...
    {
        return EAM.text("This migration renames the Strategy Standard Classification field.");
    }
    ...
    private class RenameTaxonomyCodeFieldVisitor extends AbstractMigrationORefVisitor
    {
        public RenameTaxonomyCodeFieldVisitor(int typeToVisit, boolean reverseMigration)
        {
            type = typeToVisit;
        ...
        protected BiDirectionalHashMap createLegacyToNewTagMap()
        {
            ...
            oldToNewTagMap.put(LEGACY_TAG_TAXONOMY_CODE, TAG_TAXONOMY_CODE);
    ...
    public static final int VERSION_FROM = 81;
    public static final int VERSION_TO = 82;

    public static final String LEGACY_TAG_TAXONOMY_CODE = "TaxonomyCode";
    public static final String TAG_TAXONOMY_CODE = "StandardClassificationV11Code";
}