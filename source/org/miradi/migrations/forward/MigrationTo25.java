...
public class MigrationTo25 extends NewlyAddedFieldsMigration
{
	public MigrationTo25(RawProject rawProjectToUse)
	{
	...
	protected HashMap<String, String> createFieldsToLabelMapToModify()
	{
		...
		fieldsToAdd.put(TAG_WORKPLAN_DISPLAY_MODE, EAM.text("Work Plan Display Mode"));
	...
	public static final int VERSION_FROM = 24;
	public static final int VERSION_TO = 25;
