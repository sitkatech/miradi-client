...
public class MigrationTo49 extends AbstractMigration
{
    public MigrationTo49(RawProject rawProjectToUse)
    {
    ...
    {
        return EAM.text("This migration adds an Evidence Confidence field to Strategies, Goals & Objectives.");
    }
    ...
    public static final int VERSION_FROM = 48;
    public static final int VERSION_TO = 49;
