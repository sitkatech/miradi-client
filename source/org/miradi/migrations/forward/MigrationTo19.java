...
public class MigrationTo19 extends RenameMultipleFieldMigration
{
	public MigrationTo19(RawProject rawProject)
	{
		super(rawProject, StrategySchema.getObjectType());
	...
	{
		return EAM.text("This migration renames 1 field");
	}
