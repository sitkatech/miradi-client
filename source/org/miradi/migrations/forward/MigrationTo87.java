...
public class MigrationTo87 extends AbstractMigration
{
    public MigrationTo87(RawProject rawProjectToUse)
    {
    ...
    {
        return EAM.text("This migration renames the Threat Standard Classification field.");
    }
    ...
    public static final int VERSION_FROM = 86;
    public static final int VERSION_TO = 87;
