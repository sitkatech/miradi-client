...
public class TimeframeEditorComponent extends AbstractTimeframeEditorComponent
{
	...
	{
		return new TimeframeEditorLowerPanel(projectCalendarToUse, startEndDateUnitProviderToUse);
	}
}