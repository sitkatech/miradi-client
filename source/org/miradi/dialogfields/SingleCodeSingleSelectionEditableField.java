...
public class SingleCodeSingleSelectionEditableField extends SingleCodeEditableField
{
    public SingleCodeSingleSelectionEditableField(MainWindow mainWindowToUse, ORef refToUse, String tagToUse, ChoiceQuestion questionToUse)
    {
        super(mainWindowToUse, refToUse, tagToUse, questionToUse);
    ...
    {
        AbstractEditorComponentWithHierarchies editor = new SingleSelectionEditorComponentWithHierarchicalRows(question);
