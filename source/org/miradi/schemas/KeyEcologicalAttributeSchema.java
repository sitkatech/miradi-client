...
public class KeyEcologicalAttributeSchema extends BaseObjectSchema
{
	...
	protected void fillFieldSchemas()
	{
		...
		createFieldSchemaIdList(KeyEcologicalAttribute.TAG_INDICATOR_IDS, Indicator.getObjectType());
		...
		createPseudoStringField(KeyEcologicalAttribute.PSEUDO_TAG_VIABILITY_STATUS);
	}
}
