...
public class RtfFormExporter
{
	...
	private String getFieldData(FieldRelatedFormItem formFieldData, FormRow formRow)
	{
		...
		if (rawObjectData.isCodeStringMapData())
			return createFromStringMapData((CodeStringMapData) rawObjectData, formRow);
	...
	private String createFromStringMapData(CodeStringMapData stringMapData, FormRow formRow)
	{
