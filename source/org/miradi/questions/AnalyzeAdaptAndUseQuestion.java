...
public class AnalyzeAdaptAndUseQuestion extends DynamicChoiceWithRootChoiceItem
{
	...
	{
		ChoiceItemWithChildren headerChoiceItem = new ChoiceItemWithChildren("4Header", EAM.text("4. Analyze, Use and Adapt"), new HtmlResourceLongDescriptionProvider("dashboard/4.html", wizardManager.getOverviewStepName(SummaryView.getViewName())));
