...
public class DashboardAnalyzeAdaptAndUseQuestion extends DynamicChoiceWithRootChoiceItem
{
	...
	{
		ChoiceItemWithChildren headerChoiceItem = new ChoiceItemWithChildren("4Header", getHeaderLabel(), new HtmlResourceLongDescriptionProvider(getHeaderDescriptionFileName(), wizardManager.getOverviewStepName(SummaryView.getViewName())));
