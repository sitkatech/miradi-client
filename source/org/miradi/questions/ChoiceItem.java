...
public class ChoiceItem implements Comparable<Object>
{
	...
	public ChoiceItem(String codeToUse, String labelToUse, Color colorToUse, AbstractLongDescriptionProvider descriptionProviderToUse)
	{
		...
		XmlUtilities2.logWarningIfNotValidXmlWithoutSurroundingHtmlTags(label);
		XmlUtilities2.logWarningIfNotValidXmlWithoutSurroundingHtmlTags(descriptionProvider.getDescription());
	}
	...
	{
		return XmlUtilities2.convertXmlTextToHtmlWithoutSurroundingHtmlTags(getLabel());
	}
	
	public String getTextAsHtmlWrappedLabel()
	{
