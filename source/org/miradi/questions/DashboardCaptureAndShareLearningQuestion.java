...
public class DashboardCaptureAndShareLearningQuestion extends DynamicChoiceWithRootChoiceItem
{
	...
	{
		ChoiceItemWithChildren headerChoiceItem = new ChoiceItemWithChildren("5Header", getHeaderLabel(), new HtmlResourceLongDescriptionProvider(getHeaderDescriptionFileName(), wizardManager.getOverviewStepName(SummaryView.getViewName())));
