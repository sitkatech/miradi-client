...
public class HabitatAssociationQuestion extends StaticChoiceQuestion
{
	...
	static ChoiceItem[] getHabitatAssociationChoices()
	{
		return new ChoiceItem[] {
				new ChoiceItemWithLongDescriptionProvider(FOREST_CODE, EAM.text("Forest")),
				...
				new ChoiceItemWithLongDescriptionProvider(SAVANNA_CODE, EAM.text("Savanna")),
				...
				new ChoiceItemWithLongDescriptionProvider("3", EAM.text("Shrubland")),
				...
				new ChoiceItemWithLongDescriptionProvider("4", EAM.text("Grassland")),
				...
				new ChoiceItemWithLongDescriptionProvider("5", EAM.text("Wetlands (inland)")),
				...
				new ChoiceItemWithLongDescriptionProvider("7", EAM.text("Caves and Subterranean Habitats (non-aquatic)")),
				...
				new ChoiceItemWithLongDescriptionProvider("8", EAM.text("Desert")), 
				...
				new ChoiceItemWithLongDescriptionProvider("9", EAM.text("Marine Neritic (Submergent Nearshore Continental Shelf or Oceanic Island)")),
				...
				new ChoiceItemWithLongDescriptionProvider("10", EAM.text("Marine Oceanic")), 
				...
				new ChoiceItemWithLongDescriptionProvider("11", EAM.text("Marine Deep Benthic")), 
				...
				new ChoiceItemWithLongDescriptionProvider("13", EAM.text("Marine Coastal/Supratidal")),
				...
				new ChoiceItemWithLongDescriptionProvider("14", EAM.text("Artificial - Terrestrial")),
				...
				new ChoiceItemWithLongDescriptionProvider("15", EAM.text("Artificial - Aquatic")),
				...
				new ChoiceItemWithLongDescriptionProvider("16", EAM.text("Introduced Vegetation")),
