...
public class ReportTemplateManagementPanel extends ObjectListManagementPanel
{
	...
	{
		super(mainWindowToUse, new ReportTemplateListTablePanel(mainWindowToUse, objectRef, annotationTag), new ReportTemplatePropertiesPanel(mainWindowToUse.getProject()));
	}
