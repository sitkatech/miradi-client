...
abstract public class BasicTableCellEditorOrRendererFactory extends AbstractCellEditor implements TableCellRenderer, TableCellPreferredHeightProvider, TableCellEditor 
{
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int tableColumn)
	{
		...
		setSelectedColors(table, renderer, isSelected, row, tableColumn);
			
		return renderer;
	}

	protected void setSelectedColors(JTable table, JComponent renderer, boolean isSelected, int row, int tableColumn)
	{
		if(isSelected)
		{
