...
abstract public class LeftSideRightSideSplitterContainerTab extends DisposablePanelWithDescription
{
	...
	private RightSideDescriptionPanel createRightPanel(StaticLongDescriptionProvider mainDescriptionProvider) throws Exception
	{
	...
	abstract protected StaticLongDescriptionProvider getMainDescriptionFileName() throws Exception;
