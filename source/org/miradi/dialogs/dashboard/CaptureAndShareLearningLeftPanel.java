...
public class CaptureAndShareLearningLeftPanel extends LeftSidePanelWithSelectableRows
{
	public CaptureAndShareLearningLeftPanel(MainWindow mainWindowToUse) throws Exception
	{
		...
		createHeaderRow(EAM.text("5. Capture and Share Learning"), "", getMainDescriptionFileName(), getSummaryOverviewStepName());
		
		String title5a = EAM.text("Document Key Results and Lessons");
		createSubHeaderRow(EAM.text("5A. Document Learning"), title5a, PREPARE_DATA_FOR_ANALYSIS_RIGTH_SIDE_FILENAME, getSummaryOverviewStepName());
		...
		createSubHeaderRow(EAM.text("5B. Share Learning"), title5b, ANALYZE_RESULTS_RIGTH_SIDE_FILENAME, getSummaryOverviewStepName());
		...
		createSubHeaderRow(EAM.text("5C. Create a Learning Enviornment"), title5c, ADAPT_PROJECT_PLAN_RIGTH_SIDE_FILENAME, getSummaryOverviewStepName());
	}
