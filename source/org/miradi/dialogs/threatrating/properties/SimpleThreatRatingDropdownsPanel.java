...
public class SimpleThreatRatingDropdownsPanel extends ObjectDataInputPanel
{
	public SimpleThreatRatingDropdownsPanel(Project projectToUse)
	{
		...
		addLabelAndDropdown(EAM.text("Scope"), scopeComponent);
		addLabelAndDropdown(EAM.text("Severity"), severityComponent);
		addLabelAndDropdown(EAM.text("Irreversibility"), irreversibilityComponent);

		updateFieldsFromProject();
	}
	
	private void addLabelAndDropdown(String translatedLabel, Component dropdown)
	{
