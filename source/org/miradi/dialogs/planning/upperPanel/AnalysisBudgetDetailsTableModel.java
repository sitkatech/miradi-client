...
public class AnalysisBudgetDetailsTableModel extends CategorizedBudgetDetailsTableModel
{
	public AnalysisBudgetDetailsTableModel(Project projectToUse, PlanningTreeRowColumnProvider rowColumnProvider, RowColumnBaseObjectProvider providerToUse, String treeModelIdentifierAsTagToUse) throws Exception
	{
