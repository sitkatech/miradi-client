...
public class AnalysisTreeRebuilder extends AbstractTreeRebuilder
{
	public AnalysisTreeRebuilder(Project projectToUse, PlanningTreeRowColumnProvider rowColumnProviderToUse)
	{
