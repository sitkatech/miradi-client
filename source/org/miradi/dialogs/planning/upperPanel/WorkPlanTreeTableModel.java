...
{
	public WorkPlanTreeTableModel(Project project, PlanningTreeRootNodeAlwaysExpanded rootNode, WorkPlanRowColumnProvider rowColumnProvider) throws Exception
	{
