...
public class SubAssumptionDetailsPanelWithFormatFields extends SubAssumptionDetailsPanel
{
    public SubAssumptionDetailsPanelWithFormatFields(Project projectToUse, MainWindow mainWindowToUse, SubAssumptionFactorVisibilityControlPanel subAssumptionVisibilityButtonPanel) throws Exception
    {
        super(projectToUse, mainWindowToUse, subAssumptionVisibilityButtonPanel);
    }
