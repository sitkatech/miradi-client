...
public class SubAssumptionPropertiesPanelWithTagPanel extends AbstractSubAssumptionPropertiesPanel
{
    public SubAssumptionPropertiesPanelWithTagPanel(MainWindow mainWindow) throws Exception
    {
        super(mainWindow);
    ...
    {
        return new SubAssumptionDetailsPanelWithFormatFields(getProject(), mainWindow, subAssumptionVisibilityButtonPanel);
    }
}
