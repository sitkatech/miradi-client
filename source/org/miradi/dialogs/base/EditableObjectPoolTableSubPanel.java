...
abstract public class EditableObjectPoolTableSubPanel extends EditableObjectTableSubPanel
{
	public EditableObjectPoolTableSubPanel(Project projectToUse, int ObjectType) throws Exception
	{
