...
public class TncTabForm extends FieldPanelSpec 
{
	public TncTabForm()
	{
		...
		addLabelAndField(XenodataSchema.getObjectType(), Xenodata.TAG_PROJECT_ID);
		...
		addLabelAndField(TncProjectDataSchema.getObjectType(), TncProjectData.TAG_CAPACITY_AND_FUNDING);
