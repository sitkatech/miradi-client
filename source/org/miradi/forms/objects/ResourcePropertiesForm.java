...
public class ResourcePropertiesForm extends FieldPanelSpec
{
	public ResourcePropertiesForm()
	{
		...
		addLabelAndFieldsWithLabels(EAM.text("Label|People"), type, new String[]{ProjectResource.TAG_GIVEN_NAME, ProjectResource.TAG_SUR_NAME, ProjectResource.TAG_INITIALS});
