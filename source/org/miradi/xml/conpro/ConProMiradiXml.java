...
public interface ConProMiradiXml
{
	...
	public static final String NAME_SPACE_VERSION = "0.1";
	public static final String NAME_SPACE = "http://services.tnc.org/schema/conservation-project/" + NAME_SPACE_VERSION;
