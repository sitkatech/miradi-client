...
public class WcsXmlExporter extends XmlExporter implements WcsXmlConstants
{
	...
	public void exportProject(UnicodeWriter outToUse) throws Exception
	{
		...
		new DiagramLinkPoolExporter(this).exportObjectPool();
		...
		new ThreatReductionResultsPoolExporter(this).exportObjectPool();
		new IntermediateResultPoolExporter(this).exportObjectPool();
		new GroupBoxPoolExporter(this).exportObjectPool();
		new TextBoxPoolExporter(this).exportObjectPool();
		new ScopeBoxPoolExporter(this).exportObjectPool();
		new KeyEcologicalAttributeContainerExporter(this).exportObjectPool();
		new StressPoolExporter(this).exportObjectPool();
		...
		new MethodPoolExporter(this).exportObjectPool();
		new TaskPoolExporter(this).exportObjectPool();
