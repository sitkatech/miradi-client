...
public class LegacyScopeBoxTypeQuestion extends MultiSelectDynamicChoiceQuestion
{
	public static LegacyScopeBoxTypeQuestion createScopeBoxTypeQuestion()
	{
		if (isMainWindowNullDueToTest())
			return new LegacyScopeBoxTypeQuestion(null);
		
		return new LegacyScopeBoxTypeQuestion();
	}
	...
	private LegacyScopeBoxTypeQuestion()
	{
		this(EAM.getMainWindow().getAppPreferences());
	}
	
	public LegacyScopeBoxTypeQuestion(AppPreferences appPreferencesToUse)
	{
		super();
