...
public class TagToElementNameMap implements XmlConstants
{
	...
	private HashMap<String, String> createTaskMap()
	{
		...
		taskMap.put(Task.TAG_SUBTASK_IDS, XmlConstants.SUB_TASK_IDS);
		return taskMap;
	}
	...
	private HashMap<String, String> createIndicatorMap()
	{
		...
		indicatorMap.put(Indicator.TAG_METHOD_IDS, XmlConstants.METHOD_IDS);
	...
	private HashMap<String, String> createStrategyMap()
	{
		...
		map.put(Strategy.TAG_STANDARD_CLASSIFICATION_V11_CODE, "StandardClassification");
