...
public class ChoiceQuestionToSchemaElementNameMap extends HashMap<ChoiceQuestion, String> implements Xmpz2XmlConstants
{
	...
	private void fillMap()
	{
		...
		addItem(ThreatClassificationQuestionV20.class, VOCABULARY_CAUSE_STANDARD_CLASSIFICATION_V20_CODE);
		...
		addItem(AssumptionEvidenceConfidenceTypeQuestion.class, VOCABULARY_EVIDENCE_CONFIDENCE_ASSUMPTION);
		addItem(SubAssumptionEvidenceConfidenceTypeQuestion.class, VOCABULARY_EVIDENCE_CONFIDENCE_ASSUMPTION);
