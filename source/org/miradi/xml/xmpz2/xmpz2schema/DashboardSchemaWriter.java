...
public class DashboardSchemaWriter extends BaseObjectSchemaWriter
{
	...
	public Vector<String> createFieldSchemas() throws Exception
	{
		...
		schemaElements.add(getXmpz2XmlSchemaCreator().getSchemaWriter().createSchemaElement(getXmpz2ElementName(), DASHBOARD_STATUS_ENTRIES, DASHBOARD_STATUS_ENTRY + ".element*"));
