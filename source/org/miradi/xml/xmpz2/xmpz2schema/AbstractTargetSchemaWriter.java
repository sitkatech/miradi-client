...
public class AbstractTargetSchemaWriter extends BaseObjectSchemaWriter
{
	...
	public Vector<String> createFieldSchemas() throws Exception
	{
		...
		schemaElements.add(getXmpz2XmlSchemaCreator().getSchemaWriter().createOptionalSchemaElement(getXmpz2ElementName() + TARGET_STATUS_ELEMENT_NAME, VOCABULARY_TARGET_STATUS));
