...
public class AbstractTargetSchemaWriter extends BaseObjectSchemaWriter
{
	...
	public Vector<String> createFieldSchemas() throws Exception
	{
		...
		schemaElements.add(getXmpz2XmlSchemaCreator().getSchemaWriter().createSchemaElement8(getXmpz2ElementName() + TARGET_THREAT_RATING, XmlSchemaCreator.VOCABULARY_THREAT_RATING));
		schemaElements.add(getXmpz2XmlSchemaCreator().getSchemaWriter().createSchemaElement8(getXmpz2ElementName() + TARGET_STATUS_ELEMENT_NAME, VOCABULARY_TARGET_STATUS));
