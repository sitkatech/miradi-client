...
public class ProjectSummaryLocationSchemaWriter extends SingletonSchemaWriter
{
	...
	public Vector<String> createFieldSchemas() throws Exception
	{
		...
		schemaElements.add(getXmpz2XmlSchemaCreator().getSchemaWriter().createOptionalSchemaElement(getXmpz2ElementName() + PROJECT_LOCATION, (GEOSPATIAL_LOCATION + ".element*")));
