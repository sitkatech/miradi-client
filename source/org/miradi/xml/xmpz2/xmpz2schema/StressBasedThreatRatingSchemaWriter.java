...
public class StressBasedThreatRatingSchemaWriter extends BaseObjectSchemaWriter
{
	...
	public Vector<String> createFieldSchemas() throws Exception
	{
		...
		schemaElements.add(getXmpz2XmlSchemaCreator().getSchemaWriter().createOptionalSchemaElement(STRESS_BASED_THREAT_RATING + THREAT_TARGET_RATING, vocabularyName));
