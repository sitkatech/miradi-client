...
import org.miradi.actions.ActionOpenStandardsAnalyzeUseAndAdaptParentMenu;
import org.miradi.actions.ActionOpenStandardsAnalyzeUseAndAdaptProcessStep4a;
import org.miradi.actions.ActionOpenStandardsAnalyzeUseAndAdaptProcessStep4b;
import org.miradi.actions.ActionOpenStandardsAnalyzeUseAndAdaptProcessStep4c;
import org.miradi.actions.ActionOpenStandardsConceptualizeParentMenu;
import org.miradi.actions.ActionOpenStandardsConceptualizeProcessStep1a;
import org.miradi.actions.ActionOpenStandardsConceptualizeProcessStep1b;
import org.miradi.actions.ActionOpenStandardsConceptualizeProcessStep1c;
import org.miradi.actions.ActionOpenStandardsConceptualizeProcessStep1d;
import org.miradi.actions.ActionOpenStandardsImplementActionsAndMonitoringParentMenu;
import org.miradi.actions.ActionOpenStandardsImplementActionsAndMonitoringProcessStep3a;
import org.miradi.actions.ActionOpenStandardsImplementActionsAndMonitoringProcessStep3b;
import org.miradi.actions.ActionOpenStandardsImplementActionsAndMonitoringProcessStep3c;
import org.miradi.actions.ActionOpenStandardsPlanActionsAndMonitoringParentMenu;
import org.miradi.actions.ActionOpenStandardsPlanActionsAndMonitoringProcessStep2a;
import org.miradi.actions.ActionOpenStandardsPlanActionsAndMonitoringProcessStep2b;
import org.miradi.actions.ActionOpenStandardsPlanActionsAndMonitoringProcessStep2c;
...
public class OpenStandardsCodeToMenuItemDetailsProviderMap extends HashMap<String, Class>
{
	...
	{
		put(OpenStandardsConceptualizeQuestion.CONCEPTUALIZE_CODE, ActionOpenStandardsConceptualizeParentMenu.class);
		put(OpenStandardsConceptualizeQuestion.PROCESS_STEP_1A_CODE, ActionOpenStandardsConceptualizeProcessStep1a.class);
		put(OpenStandardsConceptualizeQuestion.PROCESS_STEP_1B_CODE, ActionOpenStandardsConceptualizeProcessStep1b.class);
		put(OpenStandardsConceptualizeQuestion.PROCESS_STEP_1C_CODE, ActionOpenStandardsConceptualizeProcessStep1c.class);
		put(OpenStandardsConceptualizeQuestion.PROCESS_STEP_1D_CODE, ActionOpenStandardsConceptualizeProcessStep1d.class);		
		...
		put(OpenStandardsPlanActionsAndMonitoringQuestion.PLAN_ACTIONS_AND_MONITORING_CODE, ActionOpenStandardsPlanActionsAndMonitoringParentMenu.class);
		put(OpenStandardsPlanActionsAndMonitoringQuestion.PROCESS_STEP_2A_CODE, ActionOpenStandardsPlanActionsAndMonitoringProcessStep2a.class);
		put(OpenStandardsPlanActionsAndMonitoringQuestion.PROCESS_STEP_2B_CODE, ActionOpenStandardsPlanActionsAndMonitoringProcessStep2b.class);
		put(OpenStandardsPlanActionsAndMonitoringQuestion.PROCESS_STEP_2C_CODE, ActionOpenStandardsPlanActionsAndMonitoringProcessStep2c.class);
		...
		put(OpenStandardsImplementActionsAndMonitoringQuestion.IMPLEMENT_ACTIONS_AND_MONITORING_HEADER_CODE, ActionOpenStandardsImplementActionsAndMonitoringParentMenu.class);
		put(OpenStandardsImplementActionsAndMonitoringQuestion.PROCESS_STEP_3A_CODE, ActionOpenStandardsImplementActionsAndMonitoringProcessStep3a.class);
		put(OpenStandardsImplementActionsAndMonitoringQuestion.PROCESS_STEP_3B_CODE, ActionOpenStandardsImplementActionsAndMonitoringProcessStep3b.class);
		put(OpenStandardsImplementActionsAndMonitoringQuestion.PROCESS_STEP_3C_CODE, ActionOpenStandardsImplementActionsAndMonitoringProcessStep3c.class);
		...
		put(OpenStandardsAnalyzeUseAndAdaptQuestion.ANALYZE_USE_AND_ADAPT_HEADER_CODE, ActionOpenStandardsAnalyzeUseAndAdaptParentMenu.class);
		put(OpenStandardsAnalyzeUseAndAdaptQuestion.PROCESS_STEP_4A_CODE, ActionOpenStandardsAnalyzeUseAndAdaptProcessStep4a.class);
		put(OpenStandardsAnalyzeUseAndAdaptQuestion.PROCESS_STEP_4B_CODE, ActionOpenStandardsAnalyzeUseAndAdaptProcessStep4b.class);
		put(OpenStandardsAnalyzeUseAndAdaptQuestion.PROCESS_STEP_4C_CODE, ActionOpenStandardsAnalyzeUseAndAdaptProcessStep4c.class);
	}
}
