...
public class TargetViabilityIdentifyIndicatorsStep extends TargetViabilityWizardStep
{
	public TargetViabilityIdentifyIndicatorsStep(WizardPanel wizardToUse)
	{
		super(wizardToUse);
	}
