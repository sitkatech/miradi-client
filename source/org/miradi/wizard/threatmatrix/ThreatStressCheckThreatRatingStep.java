...
public class ThreatStressCheckThreatRatingStep extends ThreatRatingWizardStep
{
	public ThreatStressCheckThreatRatingStep(WizardPanel wizardToUse)
	{
		super(wizardToUse);
	}
	...
	{
		return EAM.text("4) Check target-threat rating");
	}
}
