	...
	class ImportPanel extends OneColumnPanel
	{
		public ImportPanel(HyperlinkHandler hyperlinkHandler) throws Exception
		{
			...
			String buttonsText = EAM.text("<div class='WizardText'>" +	
					...
					"<td><input type='submit' name='Import Miradi Project' value='Miradi Project &gt;'></input></td>" +
					"</tr>" +
					
					"<tr>" +
					"<td></td>" + 
					"<td><input type='submit' name='Import ConPro Project' value='Import ConPro Project &gt;'></input></td>" +
					"</tr>" +
					"</table></p><br>") ; 
