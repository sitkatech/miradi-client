...
public class TestDataUpgrader extends EAMTestCase
{
	...
	public void testUpgradeTo21AddLinksInAllDOsWhereNeeded() throws Exception
	{
		...
		createObjectFile(diagramFactorDir, Integer.toString(diagramFactor13), diagramFactorTargetCM13str);
		createObjectFile(diagramFactorDir, Integer.toString(diagramFactor15), diagramFactorTargetCM15str);
		createObjectFile(diagramFactorDir, Integer.toString(diagramFactor17), diagramFactorStrategyCM17str);
		createObjectFile(diagramFactorDir, Integer.toString(diagramFactor27), diagramFactorStrategyRC27str);
		createObjectFile(diagramFactorDir, Integer.toString(diagramFactor28), diagramFactorTargetRC28str);
		createObjectFile(diagramFactorDir, Integer.toString(diagramFactor29), diagramFactorTargetRC29str);
