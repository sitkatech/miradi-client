...
public class TestDiagramView extends EAMTestCase
{
	...
	public void testGetAllSelectedCellsWithLinkages() throws Exception
	{
		...
		Vector selectedItems = DiagramView.getAllSelectedCellsWithLinkages(selectedCells, model);
		assertEquals(1, selectedItems.size());
		assertContains(linkage1, selectedItems);
		
		selectedCells[0] = node2;
		selectedItems = DiagramView.getAllSelectedCellsWithLinkages(selectedCells, model);
