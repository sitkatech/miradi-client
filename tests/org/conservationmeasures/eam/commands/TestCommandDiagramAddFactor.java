...
public class TestCommandDiagramAddFactor extends EAMTestCase
{
	...
	{
		CommandDiagramAddFactor  commandAddFactor = new CommandDiagramAddFactor(new DiagramFactorId(2));
		...
		assertEquals("not same id?", commandAddFactor.getInsertedId(), reverseCommand.getDiagramNodeId());
	}
}