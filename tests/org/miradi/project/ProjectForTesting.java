...
public class ProjectForTesting extends ProjectWithHelpers
{
	...
	public void tagDiagramFactor(DiagramObject diagramObject, DiagramFactor diagramFactor, TaggedObjectSet taggedObjectSet, boolean selectTag) throws Exception
	{
		ORefList taggedObjectSetRefs = new ORefList(taggedObjectSet.getRef());
		setObjectData(diagramFactor, DiagramFactor.TAG_TAGGED_OBJECT_SET_REFS, taggedObjectSetRefs.toString());
	...
	public void populateCause(Cause cause) throws Exception
	{
		...
		fillObjectUsingCommand(cause.getRef(), Cause.TAG_STANDARD_CLASSIFICATION_V11_CODE, classificationQuestionV11.getCode(FIRST_CODE));
		ChoiceQuestion classificationQuestionV20 = StaticQuestionManager.getQuestion(ThreatClassificationQuestionV20.class);
		fillObjectUsingCommand(cause.getRef(), Cause.TAG_STANDARD_CLASSIFICATION_V20_CODE, classificationQuestionV20.getCode(FIRST_CODE));
	...
	public void populateSimpleThreatRatingEvidenceData(ORef threatRef, ORef targetRef, String evidenceNotes, ChoiceItem evidenceConfidence, int objectType) throws Exception
	{
		AbstractThreatRatingData threatRatingData = AbstractThreatRatingData.findOrCreateThreatRatingData(this, threatRef, targetRef, objectType);
		fillObjectUsingCommand(threatRatingData.getRef(), AbstractThreatRatingData.TAG_EVIDENCE_NOTES, evidenceNotes);
