...
public class ProjectForTesting extends ProjectWithHelpers
{
	...
	public String createSampleTaxonomyElementListAsJsonString()
	{
		...
		final String URI_ONLY_CHARS = "http+ssh://sample.com@whoever?http://sample.com?a=1&b=2#somewhere";
	...
	public void populateMeasurement(Measurement measurement) throws Exception
	{
		...
		fillObjectUsingCommand(measurement, Measurement.TAG_SAMPLING_ENABLED, SamplingBasedModeQuestion.ON_CODE);
	}
