...
public class TestTimePeriodCostsMap extends TestCaseWithProject
{
	...
	public void testMergeAddDifferentDates() throws Exception
	{
		...
		assertEquals(workUnits, mergedTimePeriodCostsMap.calculateTimePeriodCosts(dateUnit2008).getResourceUnits(resource.getRef()).getValue());
	}
	...
	public void testMergeNonConflictingExpenseAndWorkUnits() throws Exception
	{
		...
		assertEquals("wrong work untis after merge?", 1.0, timePeriodCosts.getResourceUnits(fred.getRef()).getValue());
	}
