...
public class MainTestSuite extends TestSuite
{
	...
	private void addAllTests()
	{
		...
		addTest(new TestSuite(TestMigrationTo60.class));
		addTest(new TestSuite(TestMigrationTo61.class));
		addTest(new TestSuite(TestMigrationTo62.class));
		addTest(new TestSuite(TestMigrationTo63.class));
		addTest(new TestSuite(TestMigrationTo64.class));
		addTest(new TestSuite(TestMigrationTo65.class));
		addTest(new TestSuite(TestMigrationTo66.class));
		addTest(new TestSuite(TestMigrationTo67.class));
		addTest(new TestSuite(TestMigrationTo68.class));
		addTest(new TestSuite(TestMigrationTo69.class));
		addTest(new TestSuite(TestMigrationTo70.class));
		addTest(new TestSuite(TestMigrationTo71.class));
		addTest(new TestSuite(TestMigrationTo72.class));
		addTest(new TestSuite(TestMigrationTo73.class));
		addTest(new TestSuite(TestMigrationTo74.class));
		addTest(new TestSuite(TestMigrationTo75.class));
		addTest(new TestSuite(TestMigrationTo76.class));
		addTest(new TestSuite(TestMigrationTo77.class));
		...
		addTest(new TestSuite(TestMigrationTo84.class));
		addTest(new TestSuite(TestMigrationTo85.class));
		addTest(new TestSuite(TestMigrationTo86.class));
