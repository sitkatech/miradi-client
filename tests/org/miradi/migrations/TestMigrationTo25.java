...
public class TestMigrationTo25 extends AbstractTestMigration
{
	...
	public void testTableSettingsFieldsChangedByMigration() throws Exception
	{
		...
		CodeList workPlanRowCodeListBefore = tableSettingsBefore.getCodeListFromTableSettingsMap(MigrationTo25.WORK_PLAN_ROW_CONFIGURATION_CODELIST_KEY);
		...
		CodeToCodeListMap tableSettingsMapAfterReverseMigration = getCodeToCodeListMapData(migratedProject, tableSettingsBefore.getRef(), MigrationTo25.TAG_TABLE_SETTINGS_MAP);

		assertTrue("Reverse migration should not have removed work plan budget row code list", tableSettingsMapAfterReverseMigration.contains(MigrationTo25.WORK_PLAN_ROW_CONFIGURATION_CODELIST_KEY));
		...
		CodeList workPlanRowCodeListAfterReverseMigration = tableSettingsMapAfterReverseMigration.getCodeList(MigrationTo25.WORK_PLAN_ROW_CONFIGURATION_CODELIST_KEY);
		...
		CodeToCodeListMap tableSettingsMapAfterForwardMigration = getCodeToCodeListMapData(migratedProject, tableSettingsBefore.getRef(), MigrationTo25.TAG_TABLE_SETTINGS_MAP);

		assertTrue("Forward migration should not have removed work plan row code list", tableSettingsMapAfterForwardMigration.contains(MigrationTo25.WORK_PLAN_ROW_CONFIGURATION_CODELIST_KEY));
		...
		CodeList workPlanRowCodeListAfterForwardMigration = tableSettingsMapAfterForwardMigration.getCodeList(MigrationTo25.WORK_PLAN_ROW_CONFIGURATION_CODELIST_KEY);
	...
	private Vector<String> getNewRowCodesAddedByMigration()
	{
		...
		result.add(MigrationTo25.RESOURCE_ASSIGNMENT);
		result.add(MigrationTo25.EXPENSE_ASSIGNMENT);
		return result;
	}
