...
public class TestMigrationTo33 extends AbstractTestMigration
{
	...
	public void testFieldsAddedAfterForwardMigration() throws Exception
	{
        ...
        assertTrue("Field should have been added during forward migration?", rawIndicator.containsKey(MigrationTo33.TAG_RELEVANT_STRATEGY_ACTIVITY_SET));
	}
	...
	public void testFieldsRemovedAfterReverseMigration() throws Exception
	{
        ...
        RawObject rawIndicator = rawProject.findObject(indicator.getRef());
        assertNotNull(rawIndicator);
        assertFalse("Field should have been removed during reverse migration?", rawIndicator.containsKey(MigrationTo33.TAG_RELEVANT_STRATEGY_ACTIVITY_SET));
	}
