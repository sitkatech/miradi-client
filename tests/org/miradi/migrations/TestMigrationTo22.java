...
public class TestMigrationTo22 extends AbstractTestMigration
{
	...
	public void testTableSettingsFieldsChangedByMigration() throws Exception
	{
		...
		CodeList workPlanRowCodeListBefore = tableSettingsBefore.getCodeListFromTableSettingsMap(MigrationTo22.WORK_PLAN_ROW_CONFIGURATION_CODELIST_KEY);
		...
		assertTrue("Reverse migration should not have removed work plan budget row code list", tableSettingsMapAfterReverseMigration.contains(MigrationTo22.WORK_PLAN_ROW_CONFIGURATION_CODELIST_KEY));
		...
		CodeList workPlanRowCodeListAfterReverseMigration = tableSettingsMapAfterReverseMigration.getCodeList(MigrationTo22.WORK_PLAN_ROW_CONFIGURATION_CODELIST_KEY);
		...
		assertTrue("Forward migration should not have removed work plan row code list", tableSettingsMapAfterForwardMigration.contains(MigrationTo22.WORK_PLAN_ROW_CONFIGURATION_CODELIST_KEY));
		...
		CodeList workPlanRowCodeListAfterForwardMigration = tableSettingsMapAfterForwardMigration.getCodeList(MigrationTo22.WORK_PLAN_ROW_CONFIGURATION_CODELIST_KEY);
	...
	private Vector<String> getNewRowCodesAddedByMigration()
	{
		...
		result.add(MigrationTo22.RESOURCE_ASSIGNMENT);
		result.add(MigrationTo22.EXPENSE_ASSIGNMENT);
		return result;
	}
