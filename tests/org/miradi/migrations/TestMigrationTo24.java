...
public class TestMigrationTo24 extends AbstractTestMigration
{
	...
	public void testProjectResourceTaxonomyClassificationsRemovedAfterReverseMigration() throws Exception
	{
		...
		String taxonomyClassifications = projectResource.getData(MigrationTo24.TAG_TAXONOMY_CLASSIFICATION_CONTAINER);
		...
		assertFalse("Field should have been removed during reverse migration?", rawProjectResource.containsKey(MigrationTo24.TAG_TAXONOMY_CLASSIFICATION_CONTAINER));
	}
	...
	public void testResourceAssignmentTaxonomyClassificationsRemovedAfterReverseMigration() throws Exception
	{
		...
		String taxonomyClassifications = resourceAssignment.getData(MigrationTo24.TAG_TAXONOMY_CLASSIFICATION_CONTAINER);
		assertNotNull(taxonomyClassifications);

		RawProject rawProject = reverseMigrate(new VersionRange(MigrationTo24.VERSION_TO));
        RawObject rawResourceAssignment = rawProject.findObject(resourceAssignment.getRef());
        assertNotNull(rawResourceAssignment);
		assertFalse("Field should have been removed during reverse migration?", rawResourceAssignment.containsKey(MigrationTo24.TAG_TAXONOMY_CLASSIFICATION_CONTAINER));
	}
	...
	public void testExpenseAssignmentTaxonomyClassificationsRemovedAfterReverseMigration() throws Exception
	{
		...
		String taxonomyClassifications = expenseAssignment.getData(MigrationTo24.TAG_TAXONOMY_CLASSIFICATION_CONTAINER);
		assertNotNull(taxonomyClassifications);

		RawProject rawProject = reverseMigrate(new VersionRange(MigrationTo24.VERSION_TO));
        RawObject rawExpenseAssignment = rawProject.findObject(expenseAssignment.getRef());
        assertNotNull(rawExpenseAssignment);
		assertFalse("Field should have been removed during reverse migration?", rawExpenseAssignment.containsKey(MigrationTo24.TAG_TAXONOMY_CLASSIFICATION_CONTAINER));
	}
