...
public class TestMigrationTo26 extends AbstractTestMigration
{
	...
	public void testResourceAssignmentAccountingClassificationsRemovedAfterReverseMigration() throws Exception
	{
		...
		String accountingClassifications = resourceAssignment.getData(MigrationTo26.TAG_ACCOUNTING_CLASSIFICATION_CONTAINER);
		...
		assertFalse("Field should have been removed during reverse migration?", rawResourceAssignment.containsKey(MigrationTo26.TAG_ACCOUNTING_CLASSIFICATION_CONTAINER));
	...
	public void testExpenseAssignmentAccountingClassificationsRemovedAfterReverseMigration() throws Exception
	{
		...
		String accountingClassifications = expenseAssignment.getData(MigrationTo26.TAG_ACCOUNTING_CLASSIFICATION_CONTAINER);
		assertNotNull(accountingClassifications);
		...
		assertFalse("Field should have been removed during reverse migration?", rawExpenseAssignment.containsKey(MigrationTo26.TAG_ACCOUNTING_CLASSIFICATION_CONTAINER));
